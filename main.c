...
void main()
{
    ...
    SDL_WM_SetCaption("salem enigme", NULL); //window title
    
	bg=IMG_Load("Assets/graphic/stages/oil_map1.jpg");
	bgpos.x=0;
	bgpos.y=0;

	 tr=IMG_Load("Assets/graphic/cheestt.png");
	SDL_Rect trpos;
	trpos.x=600;
	trpos.y=500;
...
poschoix.x=600;
poschoix.y=400;
choix= IMG_Load("Assets/graphic/EE.png");
